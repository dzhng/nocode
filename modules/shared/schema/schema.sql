...
create type public.operation_type as enum ('create_record', 'update_record', 'update_cell', 'update_field', 'delete_record');
...
create table public.operations (
  ...
  "slug"          uuid default null,
  "value"         jsonb default null
);
comment on table public.operations is 'Tracks all operations made in a sheet, used for syncing up data. All changes should start from an operation';
